...
class ServicesController extends BaseController
{
    ...
    public function getServices(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\GetServicesResponse');
    }
    ...
    public function createService(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\CreateServiceResponse');
    }
     ...
     * @param integer $resourceId    (optional) Retrieve available slots only for this Resource.  You must be
     *                               authorized to manage this Resource.
     * @param string  $startDate     (optional) Start Date of a range to check for availability.  If supplied, date
     *                               must not be supplied and end_date must be supplied.  Several formats are supported:
     *                               '2014-10-31', 'October 31, 2014'.
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getServiceAvailableSlotsById(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\GetServiceAvailableSlotsByIdResponse');
    }
    ...
    public function getServiceById(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\GetServiceByIdResponse');
    }
    ...
    public function updateServiceById(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\UpdateServiceByIdResponse');
    }
    ...
    public function deleteServiceById(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\DeleteServiceByIdResponse');
    }
}
