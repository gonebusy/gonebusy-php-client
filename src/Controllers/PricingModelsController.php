...
class PricingModelsController {
     ...
     * @param  int|null     $options['userId']       Optional parameter: Retrieve PricingModels owned only by this User Id.  You must be authorized to manage this User Id.
                ...
                $options) 
    {
        ...
        $queryBuilder = $queryBuilder.'/pricing_models';
                ...
                $createPricingModelBody) 
    {
        ...
        //prepare query string for API call
        $queryBuilder = $queryBuilder.'/pricing_models/new';
        ...
        //prepare API request
        $request = Unirest::post($queryUrl, $headers, json_encode($createPricingModelBody));
                ...
                $options) 
    {
        ...
        //prepare query string for API call
        $queryBuilder = $queryBuilder.'/pricing_models/{id}';
     ...
     * @param  array  $options    Array with all options for search
     * @param  string                         $options['id']                                  Required parameter: TODO: type description here
     * @param  UpdatePricingModelByIdBody     $options['updatePricingModelByIdBody']          Required parameter: the content of the request
     * @return mixed response from the API call*/
                ...
                $options) 
    {
        ...
        //prepare API request
        $request = Unirest::put($queryUrl, $headers, json_encode($updatePricingModelByIdBody));
