...
class PricingModelsController extends BaseController
{
     ...
     * @param integer $userId        (optional) Retrieve PricingModels owned only by this User Id.  You must be
    ...
    public function getPricingModels(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\GetPricingModelsResponse');
    }
     ...
     *
     * @param string                        $authorization             A valid API key, in the format 'Token API_KEY'
     * @param Models\CreatePricingModelBody $createPricingModelBody    (optional) the content of the request
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createPricingModel(
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($createPricingModelBody));
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\CreatePricingModelResponse');
    }
    ...
    public function getPricingModelById(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\GetPricingModelByIdResponse');
    }

    /**
     * Update a PricingModel by id, with params
     *
     * @param string                            $authorization                   A valid API key, in the format 'Token
     *                                                                           API_KEY'
     * @param string                            $id                              TODO: type description here
     * @param Models\UpdatePricingModelByIdBody $updatePricingModelByIdBody      (optional) the content of the request
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updatePricingModelById(
        ...
        //and invoke the API call request to fetch the response
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($updatePricingModelByIdBody));
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\UpdatePricingModelByIdResponse');
    }
}
