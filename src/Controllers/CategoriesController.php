...
class CategoriesController extends BaseController
{
     ...
     * @param integer $userId        (optional) Retrieve Categories of all services provided by this User Id.  You must
    ...
    public function getCategories(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\GetCategoriesResponse');
    }
     ...
     *
     * @param string                    $authorization        A valid API key, in the format 'Token API_KEY'
     * @param Models\CreateCategoryBody $createCategoryBody   (optional) the content of the request
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createCategory(
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($createCategoryBody));
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\CreateCategoryResponse');
    }
    ...
    public function getCategoryById(
        ...
        return $mapper->mapClass($response->body, 'GonebusyLib\\Models\\GetCategoryByIdResponse');
    }
}
