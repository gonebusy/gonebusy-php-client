...
class CategoriesController {
     ...
     * @param  int|null     $options['userId']       Optional parameter: Retrieve Categories of all services provided by this User Id.  You must be authorized to manage this User Id.
                ...
                $options) 
    {
        ...
        $queryBuilder = $queryBuilder.'/categories';
                ...
                $createCategoryBody) 
    {
        ...
        //prepare query string for API call
        $queryBuilder = $queryBuilder.'/categories/new';
        ...
        //prepare API request
        $request = Unirest::post($queryUrl, $headers, json_encode($createCategoryBody));
                ...
                $options) 
    {
        ...
        //prepare query string for API call
        $queryBuilder = $queryBuilder.'/categories/{id}';
