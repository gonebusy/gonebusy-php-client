...
class ResourcesController extends BaseController {
                ...
                $options) 
    {
        ...
        return $mapper->map($response->body, new Models\DeleteResourceByIdResponse());
    }
     ...
     * @param  string                     $options['authorization']                  Required parameter: A valid API key, in the format 'Token API_KEY'
     * @param  string                     $options['id']                             Required parameter: Example: 
     * @param  Models\UpdateResourceByIdBody $options['updateResourceByIdBody']         Required parameter: the content of the request
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
                ...
                $options) 
    {
        ...
        //and invoke the API call request to fetch the response
        $response = Request::put($_queryUrl, $_headers, Request\Body::Json($this->val($options, 'update_resource_by_id_body')));
        ...
        return $mapper->map($response->body, new Models\UpdateResourceByIdResponse());
    }
                ...
                $options) 
    {
        ...
        return $mapper->map($response->body, new Models\GetResourceByIdResponse());
    }
                ...
                $options) 
    {
        ...
        return $mapper->map($response->body, new Models\GetResourceThingsResponse());
    }
     ...
     * @param  array  $options    Array with all options for search
     * @param  string                 $options['authorization']            Required parameter: A valid API key, in the format 'Token API_KEY'
     * @param  Models\CreateResourceBody $options['createResourceBody']       Required parameter: the content of the request
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
                ...
                $options) 
    {
        ...
        //and invoke the API call request to fetch the response
        $response = Request::post($_queryUrl, $_headers, Request\Body::Json($this->val($options, 'create_resource_body')));
        ...
        return $mapper->map($response->body, new Models\CreateResourceResponse());
    }
     ...
     * @param  integer     $options['page']              Optional parameter: Page offset to fetch.
     * @param  integer     $options['perPage']           Optional parameter: Number of results to return per page.
     * @param  integer     $options['userId']            Optional parameter: Retrieve Resources owned only by this User Id.  You must be authorized to manage this User Id.
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
                ...
                $options) 
    {
        ...
        return $mapper->map($response->body, new Models\GetResourcesResponse());
    }
