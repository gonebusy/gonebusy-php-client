...
class EntitiesPricingModelResponse implements JsonSerializable
{
    ...
    /**
     * price/rate
     * @var string|null $price public property
     */
    public $price;
     ...
     * @var string|null $pricingModelType public property
     */
     ...
     * @param string  $price            Initialization value for $this->price
     * @param string  $pricingModelType Initialization value for $this->pricingModelType
     */
