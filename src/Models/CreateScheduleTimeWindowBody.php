...
class CreateScheduleTimeWindowBody implements JsonSerializable {
     ...
     * @param DateTime $startDate public property
     */
    protected $startDate;
     ...
     * @param string $startTime public property
     */
    protected $startTime;

    /**
     * End Time of TimeWindow.  Several formats are supported: '5pm', '17:00', '1700'
     * @param string $endTime public property
     */
    protected $endTime;
     ...
     * @param string $days public property
     */
    protected $days;

    /**
     * One of the possible recurrence values
     * @param string $recursBy public property
     */
    protected $recursBy;
	 ...
	 * @param   DateTime          $startDate        Initialization value for the property $this->startDate     
