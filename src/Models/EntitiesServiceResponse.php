...
class EntitiesServiceResponse implements JsonSerializable
{
     ...
     * @var array|null $categories public property
     */
    public $categories;
     ...
     * @maps max_duration
     * @var integer|null $maxDuration public property
     */
    public $maxDuration;
     ...
     * id of Pricing Model
     * @maps price_model_id
     * @var integer|null $priceModelId public property
     */
    public $priceModelId;
     ...
     * @var array|null $schedules public property
     */
    public $schedules;
